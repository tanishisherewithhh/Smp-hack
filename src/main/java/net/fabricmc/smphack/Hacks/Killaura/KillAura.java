...
public class KillAura extends MainGui {
   ...
   public static LivingEntity lowestHealthEntity = null;
    ...
    private boolean isValidTarget(LivingEntity entity) {
        if (entity.isDead() || entity.isInvulnerable() || entity == MinecraftClient.getInstance().player || entity.isInvisible()) {
            return false;
        }
    ...
    private void attackEntity(LivingEntity target) {
        ...
        } else if (lowestHealthEntity.getHealth() < 0 || lowestHealthEntity.isDead() || lowestHealthEntity == null)
            return;
