...
public class ConfigScreen {
    public Screen openconfigscreen() {
        ...
        hud.addEntry(entryBuilder.startBooleanToggle(Text.of("Show Muppet"), GeneralConfig.getConfig().getShowMuppet())
                ...
                .build());
        hud.addEntry(entryBuilder.startBooleanToggle(Text.of("Custom Background"), GeneralConfig.getConfig().isCustomBG())
                .setDefaultValue(false)
                .setSaveConsumer(newValue -> GeneralConfig.getConfig().setCustomBG(newValue))
                .build());
